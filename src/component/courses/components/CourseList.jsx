  ...
  return (
    <div className="flex h-full w-full flex-col items-center overflow-x-hidden bg-[#042451] pt-37.5 font-comfortaa text-white">
      ...
      <section className="flex w-full flex-col items-center ">
        ...
        >
          {dict?.course_1 ||
            "CO-DE Academy is a coding school for kids and teens."}
        </p>
        <p className="my-14 w-[80%] text-center text-lg md:text-xl opacity-80">
          {dict?.course_2 ||
            "We offer a variety of courses that cover different programming languages and skills, from Scratch to Python, Roblox, and more. Our courses are designed to help students develop their coding skills and prepare for future careers in technology."}
        </p>
      </section>
