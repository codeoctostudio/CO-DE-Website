...
const TrendsContent = () => {
  ...
  const tabs = [
    ...
    { key: "student", label: dict.category_reward },
  ];
  ...
  // 3. รวมข้อมูล Hardcode + API เข้าด้วยกัน
  const articles = [...apiBlogs, ...hardcodedArticles];
  ...
  const studentArticles = articles.filter(
    (article) => article.category === "reward",
  );

  const studentWorks = [
    { title: dict.Blogs_Student_1, meta: dict.Blogs_Student_2 },
    { title: dict.Blogs_Student_3, meta: dict.Blogs_Student_4 },
  ];
    ...
    <main className="font-comfortaa">
      ...
      <div>
        <div className="mx-auto max-w-full">
            ...
            <div className="px-4 py-10 md:px-12 lg:px-20">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                {latestArticles.map((item, idx) => {
                  const cat = categories[item.category] || categories.tech;
                  return (
                    <Link
              ...
              <div className="space-y-4">
                {currentOldArticles.map((item, idx) => {
                  const cat = categories[item.category] || categories.tech;
                  return (
                    <Link
                      key={`${item.category}-${idx}`}
                  ...
                  <div className="mt-6 flex flex-wrap justify-center gap-2">
                    ...
                    {[...Array(totalPages)].map((_, i) => (
                      <button
                        ...
                        className={`rounded-lg px-3 py-1 font-bold transition ${currentPage === i + 1 ? "bg-[#F7C94B] text-[#0B2545]" : "border bg-white hover:bg-gray-100"}`}
                      >
                        {i + 1}
                      </button>
                    ))}
          ...
          {/* TAB 2: PARENTS */}
          {activeTab === "parents" && (
            <div className="bg-linear-to-b from-[#ffecf8] via-[#f8fffa] to-white px-4 py-10 md:px-12 lg:px-20">
              <div className="mx-auto mb-5 max-w-6xl">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center rounded-full bg-pink-100 px-4 py-2 text-sm font-bold text-pink-700 shadow-sm">
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  {parentArticles.map((item, index) => (
                    <Link key={item.slug + index} href={langPath(item.slug)}>
                      <div className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-pink-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                        <div className="relative overflow-hidden bg-linear-to-br from-pink-100 to-white p-8">
          ...
          {/* TAB 3: TUTORIALS */}
          {activeTab === "tutorials" && (
            <div className="bg-linear-to-b from-[#eeffec] via-[#f8fffa] to-white px-4 py-10 md:px-12 lg:px-20">
              <div className="mx-auto mb-5 max-w-6xl">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center rounded-full bg-green-100 px-4 py-2 text-sm font-bold text-green-700 shadow-sm">
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  {tutorialsArticles.map((item, index) => (
                    <Link key={item.slug + index} href={langPath(item.slug)}>
                      <div className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-green-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                        <div className="relative overflow-hidden bg-linear-to-br from-green-100 to-white p-8">
                          <div className="relative z-10 flex items-center justify-between">
                            <div className="rounded-full bg-green-600 px-4 py-1 text-xs font-bold text-white shadow">
                              {dict.category_tutorials}
                            </div>
                            <div className="text-5xl transition-transform duration-300 group-hover:scale-110">
                              🧩
                        ...
                        <div className="flex flex-1 flex-col p-6">
                          <h3
                            className={`line-clamp-2 text-xl font-bold leading-snug text-[#042451] transition-colors group-hover:text-green-600 ${
                              lang === "th" ? "looped-text" : ""
                            }`}
                          >
                            {item.title}
          ...
          {/* TAB 4: TECH */}
          {activeTab === "tech" && (
            <div className="bg-linear-to-b from-[#ecf7ff] via-[#f8fcff] to-white px-4 py-10 md:px-12 lg:px-20">
              <div className="mx-auto mb-5 max-w-6xl">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center rounded-full bg-blue-100 px-4 py-2 text-sm font-bold text-blue-700 shadow-sm">
                    🤖 {dict.category_tech}
                  </div>
                  <h2
                    className={`mt-5 text-3xl font-extrabold text-[#042451] md:text-5xl ${
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  {techArticles.map((item, index) => (
                    <Link key={item.slug + index} href={langPath(item.slug)}>
                      <div className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-blue-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                        <div className="relative overflow-hidden bg-linear-to-br from-blue-100 to-white p-8">
                          <div className="relative z-10 flex items-center justify-between">
                            <div className="rounded-full bg-blue-600 px-4 py-1 text-xs font-bold text-white shadow">
                              {dict.category_tech}
                            </div>
                            <div className="text-5xl transition-transform duration-300 group-hover:scale-110">
                              🤖
                        ...
                        <div className="flex flex-1 flex-col p-6">
                          <h3
                            className={`line-clamp-2 text-xl font-bold leading-snug text-[#042451] transition-colors group-hover:text-blue-600 ${
                              lang === "th" ? "looped-text" : ""
                            }`}
                          >
                            {item.title}
          ...
          {/* TAB 5: GUIDE */}
          {activeTab === "guide" && (
            <div className="bg-linear-to-b from-[#fffbeb] via-[#fffdf5] to-white px-4 py-10 md:px-12 lg:px-20">
              <div className="mx-auto mb-5 max-w-6xl">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center rounded-full bg-amber-100 px-4 py-2 text-sm font-bold text-amber-700 shadow-sm">
                    📖 {dict.category_guide || "Guide Section"}
                  </div>
                  <h2
                    className={`mt-5 text-3xl font-extrabold text-[#042451] md:text-5xl ${
                      lang === "th" ? "looped-text" : ""
                  ...
                  >
                    {dict.Tab_Guide_1 || "Guide Section"}
                  </h2>
                  {dict.Tab_Guide_desc && (
                    <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-gray-500 md:text-base">
                      {dict.Tab_Guide_desc}
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  {guideArticles?.map((item, index) => (
                    <Link key={item.slug + index} href={langPath(item.slug)}>
                      <div className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-amber-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                        <div className="relative overflow-hidden bg-linear-to-br from-amber-100 to-white p-8">
                          <div className="relative z-10 flex items-center justify-between">
                            <div className="rounded-full bg-amber-500 px-4 py-1 text-xs font-bold text-white shadow">
                              {dict.category_guide || "Guide"}
                            </div>
                            <div className="text-5xl transition-transform duration-300 group-hover:scale-110">
                              📖
                            </div>
                        ...
                        <div className="flex flex-1 flex-col p-6">
                          <h3
                            className={`line-clamp-2 text-xl font-bold leading-snug text-[#042451] transition-colors group-hover:text-amber-600 ${
                              lang === "th" ? "looped-text" : ""
                            }`}
                          >
                            {item.title}
          ...
          {/* TAB 6: STUDENT */}
          {activeTab === "student" && (
            <div className="bg-linear-to-b from-[#e2b85a]/10 via-[#e2b85a]/5 to-white px-4 py-10 md:px-12 lg:px-20">
              <div className="mx-auto mb-5 max-w-6xl">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center rounded-full bg-[#e2b85a]/20 text-[#694f11] px-4 py-2 text-sm font-bold shadow-sm">
                    🎓 {dict.category_reward || "Student Works"}
                  </div>
                  <h2
                    className={`mt-5 text-3xl font-extrabold text-[#042451] md:text-5xl ${
                      lang === "th" ? "looped-text" : ""
                  ...
                  >
                    {dict.Tab_Student_1 || "Student Works Section"}
                  </h2>
                  {dict.Tab_Student_desc && (
                    <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-gray-500 md:text-base">
                      {dict.Tab_Student_desc}
                    </p>
                  )}
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  {studentArticles?.map((item, index) => (
                    <Link key={item.slug + index} href={langPath(item.slug)}>
                      <div className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-purple-100 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                        <div className="relative overflow-hidden bg-linear-to-br from-purple-100 to-white p-8">
                          <div className="relative z-10 flex items-center justify-between">
                            <div className="rounded-full bg-purple-600 px-4 py-1 text-xs font-bold text-white shadow">
                              {dict.category_student || "Student Works"}
                            </div>
                            <div className="text-5xl transition-transform duration-300 group-hover:scale-110">
                              🎓
                            </div>
                        ...
                        <div className="flex flex-1 flex-col p-6">
                          <h3
                            className={`line-clamp-2 text-xl font-bold leading-snug text-[#042451] transition-colors group-hover:text-purple-600 ${
                              lang === "th" ? "looped-text" : ""
                            }`}
                          >
                            {item.title}
