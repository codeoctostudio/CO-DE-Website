import PythonPage from "@/component/courses/IndividualCoursePages/Python/PythonPage";
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: dict?.Course_fundamental_python_Page || "CO-DE academy",
    description:
...
export default function PythonPagese() {
  return <PythonPage />;
}
