...
const Layer3 = () => {
  ...
  const courses = [
    {
      image: "/assets/courses/squarebanner01.webp",
      courseName: t("layer3_0_1"),
      forKids: t("layer3_0_1_1"),
      age: t("layer3_0_2"),
      direct: langPath("/courses/noncode"),
      color: "to-yellow-100",
    },
    {
      image: "/assets/courses/squarebanner02.webp",
      courseName: t("layer3_1_1"),
      forKids: t("layer3_1_1_1"),
      age: t("layer3_1_2"),
      direct: langPath("/courses/blockcode"),
      color: "to-green-100",
    },
    {
      image: "/assets/courses/squarebanner05.webp",
      courseName: t("layer3_2_1"),
      forKids: t("layer3_2_1_1"),
      age: t("layer3_2_2"),
      direct: langPath("/courses/mechanical"),
      color: "to-orange-100",
    },
    {
      image: "/assets/courses/squarebanner04.webp",
      courseName: t("layer3_3_1"),
      forKids: t("layer3_3_1_1"),
      age: t("layer3_3_2"),
      direct: langPath("/courses/creative"),
      color: "to-pink-100",
    },
    {
      image: "/assets/courses/squarebanner03.webp",
      courseName: t("layer3_4_1"),
      forKids: t("layer3_4_1_1"),
      age: t("layer3_4_2"),
      direct: langPath("/courses/fundamental"),
      color: "to-blue-100",
    },
    {
      image: "/assets/courses/squarebanner06.webp",
      courseName: t("layer3_5_1"),
      forKids: t("layer3_5_1_1"),
      age: t("layer3_5_2"),
          ...
          <div className="flex w-full flex-col justify-between md:flex-row">
            ...
            <section className="mb-10 flex w-full flex-col items-center gap-10 md:mb-0 md:w-[30%]">
              <div className="flex flex-col items-center">
                <Image src="/assets/searchfilter/age.webp" alt="Age Icon" width={80} height={80} className="mb-4" />
            ...
            <section className="mb-10 flex w-full flex-col items-center gap-10 md:mb-0 md:w-[30%]">
              <div className="flex flex-col items-center">
                <Image src="/assets/searchfilter/graph.webp" alt="Skill Level Icon" width={80} height={80} className="mb-4" />
                <p className="text-center text-lg font-normal lg:text-xl">
                  {t("layer3_7")}
                </p>
              </div>
              <div className="flex flex-col">
                ...
                <div className="mb-5 flex w-full items-center">
                  ...
                  <label htmlFor="newbie" className="mr-3 text-lg">{t("layer3_7_1")}</label>
                  <div onMouseEnter={handleNewbie} onMouseLeave={handleNewbie} className="relative h-5 w-5">
                    <Image src="/assets/others/info.webp" alt="Info Icon" width={20} height={20} />
                    <div className={`absolute bottom-5 left-[20px] h-40 w-40 items-center justify-center rounded-t-full rounded-br-full bg-[#FFEDB3] px-5 text-center drop-shadow-xl ${showNewbie ? "flex" : "hidden"}`}>
                      <p className="text-xs">{t("layer3_7_1_1")}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-5 flex w-full items-center">
                  ...
                  <label htmlFor="explorer" className="mr-3 text-lg">{t("layer3_7_2")}</label>
                  <div onMouseEnter={handleExplorer} onMouseLeave={handleExplorer} className="relative h-5 w-5">
                    ...
                    <div className={`absolute bottom-5 left-[20px] h-40 w-40 items-center justify-center rounded-t-full rounded-br-full bg-[#FFEDB3] px-5 text-center drop-shadow-xl ${showExplorer ? "flex" : "hidden"}`}>
                      <p className="text-xs">{t("layer3_7_2_1")}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-5 flex w-full items-center">
                  ...
                  <label htmlFor="master" className="mr-3 text-lg">{t("layer3_7_3")}</label>
                  <div onMouseEnter={handleMaster} onMouseLeave={handleMaster} className="relative h-5 w-5">
                    ...
                    <div className={`absolute bottom-5 left-[20px] h-40 w-40 items-center justify-center rounded-t-full rounded-br-full bg-[#FFEDB3] px-5 text-center drop-shadow-xl ${showMaster ? "flex" : "hidden"}`}>
                      <p className="text-xs">{t("layer3_7_3_1")}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-10 flex w-full flex-col items-center gap-10 md:mb-0 md:w-[30%]">
              <div className="flex flex-col items-center">
                <Image src="/assets/searchfilter/laptop.webp" alt="Laptop Icon" width={80} height={80} className="mb-4" />
                <p className="text-center text-lg font-normal lg:text-xl">
                  {t("layer3_8")}
                </p>
              </div>
