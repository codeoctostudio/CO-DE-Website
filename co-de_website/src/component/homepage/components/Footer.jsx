  ...
  const contacts = [
    {
      ...
      logo: "/assets/logos/facebook2.webp",
      text: "CO-DE academy",
      key: "logo1",
    },
    {
      portal: "https://line.me/R/ti/p/@191yifch",
      logo: "/assets/logos/line2.webp",
      text: "@CO-DE",
      key: "logo2",
    },
    {
      portal: "tel:+66808300899",
      logo: "/assets/logos/phone2.webp",
      text: "0808300899",
      key: "logo3",
    },
    {
      portal: "mailto:codeacademy.ad@gmail.com",
      logo: "/assets/logos/email.webp",
    ...
    },
    {
      ...
      logo: "/assets/logos/location.webp",
      text: "CO-DE academy ",
    ...
    <footer className="h-full w-full font-comfortaa">
      <section className=" flex  flex-col items-center bg-[#042451]  md:flex-row">
        <div className="relative h-[300px] w-[300px]">
          <Image
            src="/assets/others/code_logo.webp"
