  ...
  return (
    <>
      <Helmet htmlAttributes={{ lang: i18n.language }}>
        <title>{t("Course_blockcode_dino_Page")}</title>
        <meta name="description" content="คอร์สเรียน Octo-Studio สำหรับเด็ก" />
        <meta name="keywords" content="octo-studio, เด็ก, สอนเขียนโปรแกรม" />

        {/* Open Graph (Facebook) */}
        <meta property="og:title" content="CO-DE Coding School" />
        <meta property="og:description" content="เรียน Octo-Studio สำหรับเด็กแบบสนุก เข้าใจง่าย" />
